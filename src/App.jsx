    ...
    <div className="min-h-screen bg-black text-white">
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="text-center mb-4 sm:mb-8">
          <h1 className="text-3xl sm:text-5xl font-bold text-transparent bg-clip-text bg-white">
            CODEX
          </h1>
        </div>
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-4 sm:p-8 shadow-2xl">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <label className="block text-sm font-medium text-gray-300 mb-2">
                  Campus Drive Date <span className="text-gray-500 text-xs sm:text-sm">(Optional)</span>
                </label>
                <div className="relative">
                  <Calendar className="absolute left-3 top-3 w-4 h-4 sm:w-5 sm:h-5 text-gray-500 z-10" />
                  <DatePicker
                    ...
                    onChange={(date) => {
                      ...
                      setFormData({
                        ...formData,
                        campusDriveDate: formatted,
                      });
                    }}
                    placeholderText="Select date"
                    dateFormat="dd/MM/yyyy"
                    className="w-full bg-gray-800 border border-gray-700 rounded-lg pl-11 pr-4 text-sm sm:text-base py-2 sm:py-3 text-white placeholder-gray-500 hover:border-gray-600 cursor-pointer"
